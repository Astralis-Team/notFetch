...
export interface NotFetchParams {
  baseURL?: BaseUrl;
  headers?: Record<string, string>;
  parse?: ResponseParse;
...
export interface NotFetchResponse<Data> {
...
export type NotFetchRequestConfig<Params = undefined> = Params extends undefined
...
export type ApiNotFetchRequest<Params, Response = any> = (
  ...
  ? (requestConfig: NotFetchRequestConfig<Params>) => Promise<Response>
  : (requestConfig?: NotFetchRequestConfig<Params>) => Promise<Response>;
...
interface Instance extends NotFetch {
  NotFetch: typeof NotFetch;
  create: (params?: NotFetchParams) => NotFetch;
}

const notfetch = new NotFetch() as Instance;
notfetch.NotFetch = NotFetch;
notfetch.create = (params?: NotFetchParams) => new NotFetch(params);
export type NotFetchInstance = ReturnType<typeof notfetch.create>;

export default notfetch;
